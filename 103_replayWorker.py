...
LIMIT2 = LIMIT1*2
LIMIT3 = LIMIT1*3
ENUMS3= list(enumerate(commit_parents))[LIMIT2:LIMIT3]

for count,line in ENUMS3:
	iterCommits(count,line,"ws3")

stop = timeit.default_timer()
print "\n>>>>> "+ str(LIMIT3 - LIMIT2) + " merges were replayed in: " + str(stop - start)
#clean...
